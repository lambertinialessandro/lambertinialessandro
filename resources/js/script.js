...
new ScrollMagic.Scene({ triggerElement: '#about', duration: $('#about').height() })
	.setClassToggle('#about-link', 'active')
	.addTo(controller);
new ScrollMagic.Scene({ triggerElement: '#skills', duration: $('#skills').height() })
	.setClassToggle('#skills-link', 'active')
	.addTo(controller);
new ScrollMagic.Scene({ triggerElement: '#project', duration: $('#project').height() })
...
$(document).ready(function() {
	...
	var about_scene = new ScrollMagic.Scene({
		triggerElement: '.about-text', triggerHook: 0.7
	})
